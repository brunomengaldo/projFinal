                    ...
                    printf("<body class="container">")
                        printf("<main>")
                            ...
                            printf("<div class="jogo1">")
                                ...
                                printf("P V K <span class="coelho">C</span> D A Y P Q F H G Y <span class="tigre %s">I</span> F<br>", tigre)
                                printf("M N T L <span class="coelho">O</span> T G N O Z U W <span class="tigre %s">G</span> X J<br>", tigre)
                                printf("R H V H Q <span class="coelho">E</span> X A U F L <span class="tigre %s">R</span> T N Y<br>", tigre)
