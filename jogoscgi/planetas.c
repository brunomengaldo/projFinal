...
int main()
{
    ...
    if (tipojogo == 1)
    {
        ...
        if (strlen(palavra))
        {
            ...
            imprimir_arquivo("../planetas/header1.html");
            ...
            imprimir_arquivo("../planetas/footer1.html");
        }
    }
...

    {
        if (strlen(palavra))
        {
            imprimir_arquivo("../planetas/header2.html");
            ...
            imprimir_arquivo("../planetas/footer2.html");
        }
    }
    ...
    
    {
        if (strlen(palavra))
        {
            imprimir_arquivo("../planetas/header3.html");
            ...
            imprimir_arquivo("../planetas/footer3.html");
        }
    }
    return 0;
}
