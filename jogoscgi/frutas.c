...
int main()
{
    ...
    if (tipojogo == 1)
    {
        ...
        if (strlen(palavra))
        {
            ...
            imprimir_arquivo("../frutas/header1.html");
            ...
            imprimir_arquivo("../frutas/footer1.html");
        }
    }
...

    {
        if (strlen(palavra))
        {
            imprimir_arquivo("../frutas/header2.html");
            ...
            imprimir_arquivo("../frutas/footer2.html");
        }
    }
    ...
    
    {
        if (strlen(palavra))
        {
            imprimir_arquivo("../frutas/header3.html");
            ...
            imprimir_arquivo("../frutas/footer3.html");
        }
    }
    return 0;
}
